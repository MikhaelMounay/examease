...
const MainLayout: React.FC = function() {
    ...
    return (
        <>
            <div className="relative text-textColor bg-primaryBg">
                    ...
                    >
                        <div className="flex h-full flex-col">
                            ...
                            <div className="flex-auto">
                                <div
                                    className="flex max-h-[calc(100vh-56px)] min-h-[calc(100vh-56px)] flex-col overflow-auto">
                                    <article className="flex-auto p-4 lg:p-8 text-lg">
                                        {/* TODO: Transition */}
                                        <Outlet />
                                    </article>
                                    <div className="flex-none">
